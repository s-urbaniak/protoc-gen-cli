...
const (
	...
	FieldsService_Collections_FullMethodName = "/kitchensink.v1.FieldsService/Collections"
)
...
type FieldsServiceClient interface {
	...
	Collections(ctx context.Context, in *CollectionsRequest, opts ...grpc.CallOption) (*CollectionsRequest, error)
}
...
func (c *fieldsServiceClient) Collections(ctx context.Context, in *CollectionsRequest, opts ...grpc.CallOption) (*CollectionsRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CollectionsRequest)
	err := c.cc.Invoke(ctx, FieldsService_Collections_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FieldsServiceServer interface {
	...
	// Collections contains two message lists.
	Collections(context.Context, *CollectionsRequest) (*CollectionsRequest, error)
...
func (UnimplementedFieldsServiceServer) Collections(context.Context, *CollectionsRequest) (*CollectionsRequest, error) {
...
func _FieldsService_Collections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FieldsServiceServer).Collections(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FieldsService_Collections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FieldsServiceServer).Collections(ctx, req.(*CollectionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FieldsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FieldsService_Collections_Handler,
		},
	},
